...
`)+`
`+_);const v=y+p+o,x=y+_+a,w=jh(i,i.VERTEX_SHADER,v),b=jh(i,i.FRAGMENT_SHADER,x);i.attachShader(m,w),i.attachShader(m,b),t.index0AttributeName!==void 0?i.bindAttribLocation(m,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(m,0,"position"),i.linkProgram(m);function E(C){if(r.debug.checkShaderErrors){const I=i.getProgramInfoLog(m).trim(),F=i.getShaderInfoLog(w).trim(),X=i.getShaderInfoLog(b).trim();let B=!0,V=!0;if(i.getProgramParameter(m,i.LINK_STATUS)===!1)if(B=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(i,m,w,b);else{const z=Zh(i,w,"vertex"),G=Zh(i,b,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(m,i.VALIDATE_STATUS)+`
...
}`;function qy(r,e,t){let n=new Ef;const i=new ft,s=new ft,o=new Gt,a=new Gy({depthPacking:bg}),l=new Wy,c={},u=t.maxTextureSize,f={[dr]:En,[En]:dr,[gi]:gi},d=new Gi({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new ft},radius:{value:4}},vertexShader:Xy,fragmentShader:Yy}),h=d.clone();h.defines.HORIZONTAL_PASS=1;const g=new Rn;g.setAttribute("position",new Wt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const m=new ei(g,d),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=pp;let _=this.type;this.render=function(b,E,R){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||b.length===0)return;const S=r.getRenderTarget(),M=r.getActiveCubeFace(),C=r.getActiveMipmapLevel(),I=r.state;I.setBlending(lr),I.buffers.color.setClear(1,1,1,1),I.buffers.depth.setTest(!0),I.setScissorTest(!1);const F=_!==Pi&&this.type===Pi,X=_===Pi&&this.type!==Pi;for(let B=0,V=b.length;B<V;B++){const z=b[B],G=z.shadow;if(G===void 0){console.warn("THREE.WebGLShadowMap:",z,"has no shadow.");continue}if(G.autoUpdate===!1&&G.needsUpdate===!1)continue;i.copy(G.mapSize);const ie=G.getFrameExtents();if(i.multiply(ie),s.copy(G.mapSize),(i.x>u||i.y>u)&&(i.x>u&&(s.x=Math.floor(u/ie.x),i.x=s.x*ie.x,G.mapSize.x=s.x),i.y>u&&(s.y=Math.floor(u/ie.y),i.y=s.y*ie.y,G.mapSize.y=s.y)),G.map===null||F===!0||X===!0){const oe=this.type!==Pi?{minFilter:kn,magFilter:kn}:{};G.map!==null&&G.map.dispose(),G.map=new Yr(i.x,i.y,oe),G.map.texture.name=z.name+".shadowMap",G.camera.updateProjectionMatrix()}r.setRenderTarget(G.map),r.clear();const L=G.getViewportCount();for(let oe=0;oe<L;oe++){const Ie=G.getViewport(oe);o.set(s.x*Ie.x,s.y*Ie.y,s.x*Ie.z,s.y*Ie.w),I.viewport(o),G.updateMatrices(z,oe),n=G.getFrustum(),x(E,R,G.camera,z,this.type)}G.isPointLightShadow!==!0&&this.type===Pi&&y(G,R),G.needsUpdate=!1}_=this.type,p.needsUpdate=!1,r.setRenderTarget(S,M,C)};function y(b,E){const R=e.update(m);d.defines.VSM_SAMPLES!==b.blurSamples&&(d.defines.VSM_SAMPLES=b.blurSamples,h.defines.VSM_SAMPLES=b.blurSamples,d.needsUpdate=!0,h.needsUpdate=!0),b.mapPass===null&&(b.mapPass=new Yr(i.x,i.y)),d.uniforms.shadow_pass.value=b.map.texture,d.uniforms.resolution.value=b.mapSize,d.uniforms.radius.value=b.radius,r.setRenderTarget(b.mapPass),r.clear(),r.renderBufferDirect(E,null,R,d,m,null),h.uniforms.shadow_pass.value=b.mapPass.texture,h.uniforms.resolution.value=b.mapSize,h.uniforms.radius.value=b.radius,r.setRenderTarget(b.map),r.clear(),r.renderBufferDirect(E,null,R,h,m,null)}function v(b,E,R,S){let M=null;const C=R.isPointLight===!0?b.customDistanceMaterial:b.customDepthMaterial;if(C!==void 0)M=C;else if(M=R.isPointLight===!0?l:a,r.localClippingEnabled&&E.clipShadows===!0&&Array.isArray(E.clippingPlanes)&&E.clippingPlanes.length!==0||E.displacementMap&&E.displacementScale!==0||E.alphaMap&&E.alphaTest>0||E.map&&E.alphaTest>0){const I=M.uuid,F=E.uuid;let X=c[I];X===void 0&&(X={},c[I]=X);let B=X[F];B===void 0&&(B=M.clone(),X[F]=B,E.addEventListener("dispose",w)),M=B}if(M.visible=E.visible,M.wireframe=E.wireframe,S===Pi?M.side=E.shadowSide!==null?E.shadowSide:E.side:M.side=E.shadowSide!==null?E.shadowSide:f[E.side],M.alphaMap=E.alphaMap,M.alphaTest=E.alphaTest,M.map=E.map,M.clipShadows=E.clipShadows,M.clippingPlanes=E.clippingPlanes,M.clipIntersection=E.clipIntersection,M.displacementMap=E.displacementMap,M.displacementScale=E.displacementScale,M.displacementBias=E.displacementBias,M.wireframeLinewidth=E.wireframeLinewidth,M.linewidth=E.linewidth,R.isPointLight===!0&&M.isMeshDistanceMaterial===!0){const I=r.properties.get(M);I.light=R}return M}function x(b,E,R,S,M){if(b.visible===!1)return;if(b.layers.test(E.layers)&&(b.isMesh||b.isLine||b.isPoints)&&(b.castShadow||b.receiveShadow&&M===Pi)&&(!b.frustumCulled||n.intersectsObject(b))){b.modelViewMatrix.multiplyMatrices(R.matrixWorldInverse,b.matrixWorld);const F=e.update(b),X=b.material;if(Array.isArray(X)){const B=F.groups;for(let V=0,z=B.length;V<z;V++){const G=B[V],ie=X[G.materialIndex];if(ie&&ie.visible){const L=v(b,ie,S,M);b.onBeforeShadow(r,b,E,R,F,L,G),r.renderBufferDirect(R,null,F,L,b,G),b.onAfterShadow(r,b,E,R,F,L,G)}}}else if(X.visible){const B=v(b,X,S,M);b.onBeforeShadow(r,b,E,R,F,B,null),r.renderBufferDirect(R,null,F,B,b,null),b.onAfterShadow(r,b,E,R,F,B,null)}}const I=b.children;for(let F=0,X=I.length;F<X;F++)x(I[F],E,R,S,M)}function w(b){b.target.removeEventListener("dispose",w);for(const R in c){const S=c[R],M=b.target.uuid;M in S&&(S[M].dispose(),delete S[M])}}}function $y(r){function e(){let N=!1;const K=new Gt;let Z=null;const J=new Gt(0,0,0,0);return{setMask:function(ae){Z!==ae&&!N&&(r.colorMask(ae,ae,ae,ae),Z=ae)},setLocked:function(ae){N=ae},setClear:function(ae,Ae,Ye,gt,xt){xt===!0&&(ae*=gt,Ae*=gt,Ye*=gt),K.set(ae,Ae,Ye,gt),J.equals(K)===!1&&(r.clearColor(ae,Ae,Ye,gt),J.copy(K))},reset:function(){N=!1,Z=null,J.set(-1,0,0,0)}}}function t(){let N=!1,K=null,Z=null,J=null;return{setTest:function(ae){ae?ue(r.DEPTH_TEST):le(r.DEPTH_TEST)},setMask:function(ae){K!==ae&&!N&&(r.depthMask(ae),K=ae)},setFunc:function(ae){if(Z!==ae){switch(ae){case og:r.depthFunc(r.NEVER);break;case ag:r.depthFunc(r.ALWAYS);break;case lg:r.depthFunc(r.LESS);break;case ml:r.depthFunc(r.LEQUAL);break;case cg:r.depthFunc(r.EQUAL);break;case ug:r.depthFunc(r.GEQUAL);break;case fg:r.depthFunc(r.GREATER);break;case hg:r.depthFunc(r.NOTEQUAL);break;default:r.depthFunc(r.LEQUAL)}Z=ae}},setLocked:function(ae){N=ae},setClear:function(ae){J!==ae&&(r.clearDepth(ae),J=ae)},reset:function(){N=!1,K=null,Z=null,J=null}}}function n(){let N=!1,K=null,Z=null,J=null,ae=null,Ae=null,Ye=null,gt=null,xt=null;return{setTest:function(et){N||(et?ue(r.STENCIL_TEST):le(r.STENCIL_TEST))},setMask:function(et){K!==et&&!N&&(r.stencilMask(et),K=et)},setFunc:function(et,Oe,Se){(Z!==et||J!==Oe||ae!==Se)&&(r.stencilFunc(et,Oe,Se),Z=et,J=Oe,ae=Se)},setOp:function(et,Oe,Se){(Ae!==et||Ye!==Oe||gt!==Se)&&(r.stencilOp(et,Oe,Se),Ae=et,Ye=Oe,gt=Se)},setLocked:function(et){N=et},setClear:function(et){xt!==et&&(r.clearStencil(et),xt=et)},reset:function(){N=!1,K=null,Z=null,J=null,ae=null,Ae=null,Ye=null,gt=null,xt=null}}}const i=new e,s=new t,o=new n,a=new WeakMap,l=new WeakMap;let c={},u={},f=new WeakMap,d=[],h=null,g=!1,m=null,p=null,_=null,y=null,v=null,x=null,w=null,b=new rt(0,0,0),E=0,R=!1,S=null,M=null,C=null,I=null,F=null;const X=r.getParameter(r.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let B=!1,V=0;const z=r.getParameter(r.VERSION);z.indexOf("WebGL")!==-1?(V=parseFloat(/^WebGL (\d)/.exec(z)[1]),B=V>=1):z.indexOf("OpenGL ES")!==-1&&(V=parseFloat(/^OpenGL ES (\d)/.exec(z)[1]),B=V>=2);let G=null,ie={};const L=r.getParameter(r.SCISSOR_BOX),oe=r.getParameter(r.VIEWPORT),Ie=new Gt().fromArray(L),ze=new Gt().fromArray(oe);function $(N,K,Z,J){const ae=new Uint8Array(4),Ae=r.createTexture();r.bindTexture(N,Ae),r.texParameteri(N,r.TEXTURE_MIN_FILTER,r.NEAREST),r.texParameteri(N,r.TEXTURE_MAG_FILTER,r.NEAREST);for(let Ye=0;Ye<Z;Ye++)N===r.TEXTURE_3D||N===r.TEXTURE_2D_ARRAY?r.texImage3D(K,0,r.RGBA,1,1,J,0,r.RGBA,r.UNSIGNED_BYTE,ae):r.texImage2D(K+Ye,0,r.RGBA,1,1,0,r.RGBA,r.UNSIGNED_BYTE,ae);return Ae}const Q={};Q[r.TEXTURE_2D]=$(r.TEXTURE_2D,r.TEXTURE_2D,1),Q[r.TEXTURE_CUBE_MAP]=$(r.TEXTURE_CUBE_MAP,r.TEXTURE_CUBE_MAP_POSITIVE_X,6),Q[r.TEXTURE_2D_ARRAY]=$(r.TEXTURE_2D_ARRAY,r.TEXTURE_2D_ARRAY,1,1),Q[r.TEXTURE_3D]=$(r.TEXTURE_3D,r.TEXTURE_3D,1,1),i.setClear(0,0,0,1),s.setClear(1),o.setClear(0),ue(r.DEPTH_TEST),s.setFunc(ml),Xe(!1),ge(ch),ue(r.CULL_FACE),Ue(lr);function ue(N){c[N]!==!0&&(r.enable(N),c[N]=!0)}function le(N){c[N]!==!1&&(r.disable(N),c[N]=!1)}function Ee(N,K){return u[N]!==K?(r.bindFramebuffer(N,K),u[N]=K,N===r.DRAW_FRAMEBUFFER&&(u[r.FRAMEBUFFER]=K),N===r.FRAMEBUFFER&&(u[r.DRAW_FRAMEBUFFER]=K),!0):!1}function we(N,K){let Z=d,J=!1;if(N){Z=f.get(K),Z===void 0&&(Z=[],f.set(K,Z));const ae=N.textures;if(Z.length!==ae.length||Z[0]!==r.COLOR_ATTACHMENT0){for(let Ae=0,Ye=ae.length;Ae<Ye;Ae++)Z[Ae]=r.COLOR_ATTACHMENT0+Ae;Z.length=ae.length,J=!0}}else Z[0]!==r.BACK&&(Z[0]=r.BACK,J=!0);J&&r.drawBuffers(Z)}function Te(N){return h!==N?(r.useProgram(N),h=N,!0):!1}const Ke={[Dr]:r.FUNC_ADD,[G_]:r.FUNC_SUBTRACT,[W_]:r.FUNC_REVERSE_SUBTRACT};Ke[X_]=r.MIN,Ke[Y_]=r.MAX;const D={[q_]:r.ZERO,[$_]:r.ONE,[K_]:r.SRC_COLOR,[eu]:r.SRC_ALPHA,[tg]:r.SRC_ALPHA_SATURATE,[Q_]:r.DST_COLOR,[Z_]:r.DST_ALPHA,[j_]:r.ONE_MINUS_SRC_COLOR,[tu]:r.ONE_MINUS_SRC_ALPHA,[eg]:r.ONE_MINUS_DST_COLOR,[J_]:r.ONE_MINUS_DST_ALPHA,[ng]:r.CONSTANT_COLOR,[ig]:r.ONE_MINUS_CONSTANT_COLOR,[rg]:r.CONSTANT_ALPHA,[sg]:r.ONE_MINUS_CONSTANT_ALPHA};function Ue(N,K,Z,J,ae,Ae,Ye,gt,xt,et){if(N===lr){g===!0&&(le(r.BLEND),g=!1);return}if(g===!1&&(ue(r.BLEND),g=!0),N!==H_){if(N!==m||et!==R){if((p!==Dr||v!==Dr)&&(r.blendEquation(r.FUNC_ADD),p=Dr,v=Dr),et)switch(N){case Ps:r.blendFuncSeparate(r.ONE,r.ONE_MINUS_SRC_ALPHA,r.ONE,r.ONE_MINUS_SRC_ALPHA);break;case uh:r.blendFunc(r.ONE,r.ONE);break;case fh:r.blendFuncSeparate(r.ZERO,r.ONE_MINUS_SRC_COLOR,r.ZERO,r.ONE);break;case hh:r.blendFuncSeparate(r.ZERO,r.SRC_COLOR,r.ZERO,r.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",N);break}else switch(N){case Ps:r.blendFuncSeparate(r.SRC_ALPHA,r.ONE_MINUS_SRC_ALPHA,r.ONE,r.ONE_MINUS_SRC_ALPHA);break;case uh:r.blendFunc(r.SRC_ALPHA,r.ONE);break;case fh:r.blendFuncSeparate(r.ZERO,r.ONE_MINUS_SRC_COLOR,r.ZERO,r.ONE);break;case hh:r.blendFunc(r.ZERO,r.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",N);break}_=null,y=null,x=null,w=null,b.set(0,0,0),E=0,m=N,R=et}return}ae=ae||K,Ae=Ae||Z,Ye=Ye||J,(K!==p||ae!==v)&&(r.blendEquationSeparate(Ke[K],Ke[ae]),p=K,v=ae),(Z!==_||J!==y||Ae!==x||Ye!==w)&&(r.blendFuncSeparate(D[Z],D[J],D[Ae],D[Ye]),_=Z,y=J,x=Ae,w=Ye),(gt.equals(b)===!1||xt!==E)&&(r.blendColor(gt.r,gt.g,gt.b,xt),b.copy(gt),E=xt),m=N,R=!1}function Fe(N,K){N.side===gi?le(r.CULL_FACE):ue(r.CULL_FACE);let Z=N.side===En;K&&(Z=!Z),Xe(Z),N.blending===Ps&&N.transparent===!1?Ue(lr):Ue(N.blending,N.blendEquation,N.blendSrc,N.blendDst,N.blendEquationAlpha,N.blendSrcAlpha,N.blendDstAlpha,N.blendColor,N.blendAlpha,N.premultipliedAlpha),s.setFunc(N.depthFunc),s.setTest(N.depthTest),s.setMask(N.depthWrite),i.setMask(N.colorWrite);const J=N.stencilWrite;o.setTest(J),J&&(o.setMask(N.stencilWriteMask),o.setFunc(N.stencilFunc,N.stencilRef,N.stencilFuncMask),o.setOp(N.stencilFail,N.stencilZFail,N.stencilZPass)),Re(N.polygonOffset,N.polygonOffsetFactor,N.polygonOffsetUnits),N.alphaToCoverage===!0?ue(r.SAMPLE_ALPHA_TO_COVERAGE):le(r.SAMPLE_ALPHA_TO_COVERAGE)}function Xe(N){S!==N&&(N?r.frontFace(r.CW):r.frontFace(r.CCW),S=N)}function ge(N){N!==z_?(ue(r.CULL_FACE),N!==M&&(N===ch?r.cullFace(r.BACK):N===k_?r.cullFace(r.FRONT):r.cullFace(r.FRONT_AND_BACK))):le(r.CULL_FACE),M=N}function Y(N){N!==C&&(B&&r.lineWidth(N),C=N)}function Re(N,K,Z){N?(ue(r.POLYGON_OFFSET_FILL),(I!==K||F!==Z)&&(r.polygonOffset(K,Z),I=K,F=Z)):le(r.POLYGON_OFFSET_FILL)}function Be(N){N?ue(r.SCISSOR_TEST):le(r.SCISSOR_TEST)}function P(N){N===void 0&&(N=r.TEXTURE0+X-1),G!==N&&(r.activeTexture(N),G=N)}function T(N,K,Z){Z===void 0&&(G===null?Z=r.TEXTURE0+X-1:Z=G);let J=ie[Z];J===void 0&&(J={type:void 0,texture:void 0},ie[Z]=J),(J.type!==N||J.texture!==K)&&(G!==Z&&(r.activeTexture(Z),G=Z),r.bindTexture(N,K||Q[N]),J.type=N,J.texture=K)}function q(){const N=ie[G];N!==void 0&&N.type!==void 0&&(r.bindTexture(N.type,null),N.type=void 0,N.texture=void 0)}function ee(){try{r.compressedTexImage2D.apply(r,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function ne(){try{r.compressedTexImage3D.apply(r,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function j(){try{r.texSubImage2D.apply(r,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function be(){try{r.texSubImage3D.apply(r,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function re(){try{r.compressedTexSubImage2D.apply(r,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function de(){try{r.compressedTexSubImage3D.apply(r,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function Ne(){try{r.texStorage2D.apply(r,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function se(){try{r.texStorage3D.apply(r,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function _e(){try{r.texImage2D.apply(r,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function Pe(){try{r.texImage3D.apply(r,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function ke(N){Ie.equals(N)===!1&&(r.scissor(N.x,N.y,N.z,N.w),Ie.copy(N))}function me(N){ze.equals(N)===!1&&(r.viewport(N.x,N.y,N.z,N.w),ze.copy(N))}function Ve(N,K){let Z=l.get(K);Z===void 0&&(Z=new WeakMap,l.set(K,Z));let J=Z.get(N);J===void 0&&(J=r.getUniformBlockIndex(K,N.name),Z.set(N,J))}function We(N,K){const J=l.get(K).get(N);a.get(K)!==J&&(r.uniformBlockBinding(K,J,N.__bindingPointIndex),a.set(K,J))}function ct(){r.disable(r.BLEND),r.disable(r.CULL_FACE),r.disable(r.DEPTH_TEST),r.disable(r.POLYGON_OFFSET_FILL),r.disable(r.SCISSOR_TEST),r.disable(r.STENCIL_TEST),r.disable(r.SAMPLE_ALPHA_TO_COVERAGE),r.blendEquation(r.FUNC_ADD),r.blendFunc(r.ONE,r.ZERO),r.blendFuncSeparate(r.ONE,r.ZERO,r.ONE,r.ZERO),r.blendColor(0,0,0,0),r.colorMask(!0,!0,!0,!0),r.clearColor(0,0,0,0),r.depthMask(!0),r.depthFunc(r.LESS),r.clearDepth(1),r.stencilMask(4294967295),r.stencilFunc(r.ALWAYS,0,4294967295),r.stencilOp(r.KEEP,r.KEEP,r.KEEP),r.clearStencil(0),r.cullFace(r.BACK),r.frontFace(r.CCW),r.polygonOffset(0,0),r.activeTexture(r.TEXTURE0),r.bindFramebuffer(r.FRAMEBUFFER,null),r.bindFramebuffer(r.DRAW_FRAMEBUFFER,null),r.bindFramebuffer(r.READ_FRAMEBUFFER,null),r.useProgram(null),r.lineWidth(1),r.scissor(0,0,r.canvas.width,r.canvas.height),r.viewport(0,0,r.canvas.width,r.canvas.height),c={},G=null,ie={},u={},f=new WeakMap,d=[],h=null,g=!1,m=null,p=null,_=null,y=null,v=null,x=null,w=null,b=new rt(0,0,0),E=0,R=!1,S=null,M=null,C=null,I=null,F=null,Ie.set(0,0,r.canvas.width,r.canvas.height),ze.set(0,0,r.canvas.width,r.canvas.height),i.reset(),s.reset(),o.reset()}return{buffers:{color:i,depth:s,stencil:o},enable:ue,disable:le,bindFramebuffer:Ee,drawBuffers:we,useProgram:Te,setBlending:Ue,setMaterial:Fe,setFlipSided:Xe,setCullFace:ge,setLineWidth:Y,setPolygonOffset:Re,setScissorTest:Be,activeTexture:P,bindTexture:T,unbindTexture:q,compressedTexImage2D:ee,compressedTexImage3D:ne,texImage2D:_e,texImage3D:Pe,updateUBOMapping:Ve,uniformBlockBinding:We,texStorage2D:Ne,texStorage3D:se,texSubImage2D:j,texSubImage3D:be,compressedTexSubImage2D:re,compressedTexSubImage3D:de,scissor:ke,viewport:me,reset:ct}}function sd(r,e,t,n){const i=Ky(n);switch(t){case yp:return r*e;case Ep:return r*e;case Tp:return r*e*2;case bp:return r*e/i.components*i.byteLength;case _f:return r*e/i.components*i.byteLength;case Ap:return r*e*2/i.components*i.byteLength;case gf:return r*e*2/i.components*i.byteLength;case Sp:return r*e*3/i.components*i.byteLength;case Qn:return r*e*4/i.components*i.byteLength;case xf:return r*e*4/i.components*i.byteLength;case Ja:case Qa:return Math.floor((r+3)/4)*Math.floor((e+3)/4)*8;case el:case tl:return Math.floor((r+3)/4)*Math.floor((e+3)/4)*16;case su:case au:return Math.max(r,16)*Math.max(e,8)/4;case ru:case ou:return Math.max(r,8)*Math.max(e,8)/2;case lu:case cu:return Math.floor((r+3)/4)*Math.floor((e+3)/4)*8;case uu:return Math.floor((r+3)/4)*Math.floor((e+3)/4)*16;case fu:return Math.floor((r+3)/4)*Math.floor((e+3)/4)*16;case hu:return Math.floor((r+4)/5)*Math.floor((e+3)/4)*16;case du:return Math.floor((r+4)/5)*Math.floor((e+4)/5)*16;case pu:return Math.floor((r+5)/6)*Math.floor((e+4)/5)*16;case mu:return Math.floor((r+5)/6)*Math.floor((e+5)/6)*16;case _u:return Math.floor((r+7)/8)*Math.floor((e+4)/5)*16;case gu:return Math.floor((r+7)/8)*Math.floor((e+5)/6)*16;case xu:return Math.floor((r+7)/8)*Math.floor((e+7)/8)*16;case vu:return Math.floor((r+9)/10)*Math.floor((e+4)/5)*16;case Mu:return Math.floor((r+9)/10)*Math.floor((e+5)/6)*16;case yu:return Math.floor((r+9)/10)*Math.floor((e+7)/8)*16;case Su:return Math.floor((r+9)/10)*Math.floor((e+9)/10)*16;case Eu:return Math.floor((r+11)/12)*Math.floor((e+9)/10)*16;case Tu:return Math.floor((r+11)/12)*Math.floor((e+11)/12)*16;case nl:case bu:case Au:return Math.ceil(r/4)*Math.ceil(e/4)*16;case wp:case wu:return Math.ceil(r/4)*Math.ceil(e/4)*8;case Ru:case Cu:return Math.ceil(r/4)*Math.ceil(e/4)*16}throw new Error(`Unable to determine texture byte length for ${t} format.`)}function Ky(r){switch(r){case Vi:case xp:return{byteLength:1,components:1};case Go:case vp:case na:return{byteLength:2,components:1};case pf:case mf:return{byteLength:2,components:4};case Xr:case df:case Oi:return{byteLength:4,components:1};case Mp:return{byteLength:4,components:3}}throw new Error(`Unknown texture type ${r}.`)}function jy(r,e,t,n,i,s,o){const a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new ft,u=new WeakMap;let f;const d=new WeakMap;let h=!1;try{h=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(P,T){return h?new OffscreenCanvas(P,T):Xo("canvas")}function m(P,T,q){let ee=1;const ne=Be(P);if((ne.width>q||ne.height>q)&&(ee=q/Math.max(ne.width,ne.height)),ee<1)if(typeof HTMLImageElement<"u"&&P instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&P instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&P instanceof ImageBitmap||typeof VideoFrame<"u"&&P instanceof VideoFrame){const j=Math.floor(ee*ne.width),be=Math.floor(ee*ne.height);f===void 0&&(f=g(j,be));const re=T?g(j,be):f;return re.width=j,re.height=be,re.getContext("2d").drawImage(P,0,0,j,be),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+ne.width+"x"+ne.height+") to ("+j+"x"+be+")."),re}else return"data"in P&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+ne.width+"x"+ne.height+")."),P;return P}function p(P){return P.generateMipmaps&&P.minFilter!==kn&&P.minFilter!==Jn}function _(P){r.generateMipmap(P)}function y(P,T,q,ee,ne=!1){if(P!==null){if(r[P]!==void 0)return r[P];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+P+"'")}let j=T;if(T===r.RED&&(q===r.FLOAT&&(j=r.R32F),q===r.HALF_FLOAT&&(j=r.R16F),q===r.UNSIGNED_BYTE&&(j=r.R8)),T===r.RED_INTEGER&&(q===r.UNSIGNED_BYTE&&(j=r.R8UI),q===r.UNSIGNED_SHORT&&(j=r.R16UI),q===r.UNSIGNED_INT&&(j=r.R32UI),q===r.BYTE&&(j=r.R8I),q===r.SHORT&&(j=r.R16I),q===r.INT&&(j=r.R32I)),T===r.RG&&(q===r.FLOAT&&(j=r.RG32F),q===r.HALF_FLOAT&&(j=r.RG16F),q===r.UNSIGNED_BYTE&&(j=r.RG8)),T===r.RG_INTEGER&&(q===r.UNSIGNED_BYTE&&(j=r.RG8UI),q===r.UNSIGNED_SHORT&&(j=r.RG16UI),q===r.UNSIGNED_INT&&(j=r.RG32UI),q===r.BYTE&&(j=r.RG8I),q===r.SHORT&&(j=r.RG16I),q===r.INT&&(j=r.RG32I)),T===r.RGB&&q===r.UNSIGNED_INT_5_9_9_9_REV&&(j=r.RGB9_E5),T===r.RGBA){const be=ne?xl:pt.getTransfer(ee);q===r.FLOAT&&(j=r.RGBA32F),q===r.HALF_FLOAT&&(j=r.RGBA16F),q===r.UNSIGNED_BYTE&&(j=be===bt?r.SRGB8_ALPHA8:r.RGBA8),q===r.UNSIGNED_SHORT_4_4_4_4&&(j=r.RGBA4),q===r.UNSIGNED_SHORT_5_5_5_1&&(j=r.RGB5_A1)}return(j===r.R16F||j===r.R32F||j===r.RG16F||j===r.RG32F||j===r.RGBA16F||j===r.RGBA32F)&&e.get("EXT_color_buffer_float"),j}function v(P,T){let q;return P?T===null||T===Xr||T===Gs?q=r.DEPTH24_STENCIL8:T===Oi?q=r.DEPTH32F_STENCIL8:T===Go&&(q=r.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):T===null||T===Xr||T===Gs?q=r.DEPTH_COMPONENT24:T===Oi?q=r.DEPTH_COMPONENT32F:T===Go&&(q=r.DEPTH_COMPONENT16),q}function x(P,T){return p(P)===!0||P.isFramebufferTexture&&P.minFilter!==kn&&P.minFilter!==Jn?Math.log2(Math.max(T.width,T.height))+1:P.mipmaps!==void 0&&P.mipmaps.length>0?P.mipmaps.length:P.isCompressedTexture&&Array.isArray(P.image)?T.mipmaps.length:1}function w(P){const T=P.target;T.removeEventListener("dispose",w),E(T),T.isVideoTexture&&u.delete(T)}function b(P){const T=P.target;T.removeEventListener("dispose",b),S(T)}function E(P){const T=n.get(P);if(T.__webglInit===void 0)return;const q=P.source,ee=d.get(q);if(ee){const ne=ee[T.__cacheKey];ne.usedTimes--,ne.usedTimes===0&&R(P),Object.keys(ee).length===0&&d.delete(q)}n.remove(P)}function R(P){const T=n.get(P);r.deleteTexture(T.__webglTexture);const q=P.source,ee=d.get(q);delete ee[T.__cacheKey],o.memory.textures--}function S(P){const T=n.get(P);if(P.depthTexture&&P.depthTexture.dispose(),P.isWebGLCubeRenderTarget)for(let ee=0;ee<6;ee++){if(Array.isArray(T.__webglFramebuffer[ee]))for(let ne=0;ne<T.__webglFramebuffer[ee].length;ne++)r.deleteFramebuffer(T.__webglFramebuffer[ee][ne]);else r.deleteFramebuffer(T.__webglFramebuffer[ee]);T.__webglDepthbuffer&&r.deleteRenderbuffer(T.__webglDepthbuffer[ee])}else{if(Array.isArray(T.__webglFramebuffer))for(let ee=0;ee<T.__webglFramebuffer.length;ee++)r.deleteFramebuffer(T.__webglFramebuffer[ee]);else r.deleteFramebuffer(T.__webglFramebuffer);if(T.__webglDepthbuffer&&r.deleteRenderbuffer(T.__webglDepthbuffer),T.__webglMultisampledFramebuffer&&r.deleteFramebuffer(T.__webglMultisampledFramebuffer),T.__webglColorRenderbuffer)for(let ee=0;ee<T.__webglColorRenderbuffer.length;ee++)T.__webglColorRenderbuffer[ee]&&r.deleteRenderbuffer(T.__webglColorRenderbuffer[ee]);T.__webglDepthRenderbuffer&&r.deleteRenderbuffer(T.__webglDepthRenderbuffer)}const q=P.textures;for(let ee=0,ne=q.length;ee<ne;ee++){const j=n.get(q[ee]);j.__webglTexture&&(r.deleteTexture(j.__webglTexture),o.memory.textures--),n.remove(q[ee])}n.remove(P)}let M=0;function C(){M=0}function I(){const P=M;return P>=i.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+P+" texture units while this GPU supports only "+i.maxTextures),M+=1,P}function F(P){const T=[];return T.push(P.wrapS),T.push(P.wrapT),T.push(P.wrapR||0),T.push(P.magFilter),T.push(P.minFilter),T.push(P.anisotropy),T.push(P.internalFormat),T.push(P.format),T.push(P.type),T.push(P.generateMipmaps),T.push(P.premultiplyAlpha),T.push(P.flipY),T.push(P.unpackAlignment),T.push(P.colorSpace),T.join()}function X(P,T){const q=n.get(P);if(P.isVideoTexture&&Y(P),P.isRenderTargetTexture===!1&&P.version>0&&q.__version!==P.version){const ee=P.image;if(ee===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(ee.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{ze(q,P,T);return}}t.bindTexture(r.TEXTURE_2D,q.__webglTexture,r.TEXTURE0+T)}function B(P,T){const q=n.get(P);if(P.version>0&&q.__version!==P.version){ze(q,P,T);return}t.bindTexture(r.TEXTURE_2D_ARRAY,q.__webglTexture,r.TEXTURE0+T)}function V(P,T){const q=n.get(P);if(P.version>0&&q.__version!==P.version){ze(q,P,T);return}t.bindTexture(r.TEXTURE_3D,q.__webglTexture,r.TEXTURE0+T)}function z(P,T){const q=n.get(P);if(P.version>0&&q.__version!==P.version){$(q,P,T);return}t.bindTexture(r.TEXTURE_CUBE_MAP,q.__webglTexture,r.TEXTURE0+T)}const G={[_l]:r.REPEAT,[tr]:r.CLAMP_TO_EDGE,[gl]:r.MIRRORED_REPEAT},ie={[kn]:r.NEAREST,[gp]:r.NEAREST_MIPMAP_NEAREST,[mo]:r.NEAREST_MIPMAP_LINEAR,[Jn]:r.LINEAR,[Za]:r.LINEAR_MIPMAP_NEAREST,[nr]:r.LINEAR_MIPMAP_LINEAR},L={[Rg]:r.NEVER,[Ug]:r.ALWAYS,[Cg]:r.LESS,[Rp]:r.LEQUAL,[Pg]:r.EQUAL,[Ig]:r.GEQUAL,[Lg]:r.GREATER,[Dg]:r.NOTEQUAL};function oe(P,T){if(T.type===Oi&&e.has("OES_texture_float_linear")===!1&&(T.magFilter===Jn||T.magFilter===Za||T.magFilter===mo||T.magFilter===nr||T.minFilter===Jn||T.minFilter===Za||T.minFilter===mo||T.minFilter===nr)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),r.texParameteri(P,r.TEXTURE_WRAP_S,G[T.wrapS]),r.texParameteri(P,r.TEXTURE_WRAP_T,G[T.wrapT]),(P===r.TEXTURE_3D||P===r.TEXTURE_2D_ARRAY)&&r.texParameteri(P,r.TEXTURE_WRAP_R,G[T.wrapR]),r.texParameteri(P,r.TEXTURE_MAG_FILTER,ie[T.magFilter]),r.texParameteri(P,r.TEXTURE_MIN_FILTER,ie[T.minFilter]),T.compareFunction&&(r.texParameteri(P,r.TEXTURE_COMPARE_MODE,r.COMPARE_REF_TO_TEXTURE),r.texParameteri(P,r.TEXTURE_COMPARE_FUNC,L[T.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(T.magFilter===kn||T.minFilter!==mo&&T.minFilter!==nr||T.type===Oi&&e.has("OES_texture_float_linear")===!1)return;if(T.anisotropy>1||n.get(T).__currentAnisotropy){const q=e.get("EXT_texture_filter_anisotropic");r.texParameterf(P,q.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(T.anisotropy,i.getMaxAnisotropy())),n.get(T).__currentAnisotropy=T.anisotropy}}}function Ie(P,T){let q=!1;P.__webglInit===void 0&&(P.__webglInit=!0,T.addEventListener("dispose",w));const ee=T.source;let ne=d.get(ee);ne===void 0&&(ne={},d.set(ee,ne));const j=F(T);if(j!==P.__cacheKey){ne[j]===void 0&&(ne[j]={texture:r.createTexture(),usedTimes:0},o.memory.textures++,q=!0),ne[j].usedTimes++;const be=ne[P.__cacheKey];be!==void 0&&(ne[P.__cacheKey].usedTimes--,be.usedTimes===0&&R(T)),P.__cacheKey=j,P.__webglTexture=ne[j].texture}return q}function ze(P,T,q){let ee=r.TEXTURE_2D;(T.isDataArrayTexture||T.isCompressedArrayTexture)&&(ee=r.TEXTURE_2D_ARRAY),T.isData3DTexture&&(ee=r.TEXTURE_3D);const ne=Ie(P,T),j=T.source;t.bindTexture(ee,P.__webglTexture,r.TEXTURE0+q);const be=n.get(j);if(j.version!==be.__version||ne===!0){t.activeTexture(r.TEXTURE0+q);const re=pt.getPrimaries(pt.workingColorSpace),de=T.colorSpace===Ii?null:pt.getPrimaries(T.colorSpace),Ne=T.colorSpace===Ii||re===de?r.NONE:r.BROWSER_DEFAULT_WEBGL;r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,T.flipY),r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,T.premultiplyAlpha),r.pixelStorei(r.UNPACK_ALIGNMENT,T.unpackAlignment),r.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ne);let se=m(T.image,!1,i.maxTextureSize);se=Re(T,se);const _e=s.convert(T.format,T.colorSpace),Pe=s.convert(T.type);let ke=y(T.internalFormat,_e,Pe,T.colorSpace,T.isVideoTexture);oe(ee,T);let me;const Ve=T.mipmaps,We=T.isVideoTexture!==!0,ct=be.__version===void 0||ne===!0,N=j.dataReady,K=x(T,se);if(T.isDepthTexture)ke=v(T.format===Ws,T.type),ct&&(We?t.texStorage2D(r.TEXTURE_2D,1,ke,se.width,se.height):t.texImage2D(r.TEXTURE_2D,0,ke,se.width,se.height,0,_e,Pe,null));else if(T.isDataTexture)if(Ve.length>0){We&&ct&&t.texStorage2D(r.TEXTURE_2D,K,ke,Ve[0].width,Ve[0].height);for(let Z=0,J=Ve.length;Z<J;Z++)me=Ve[Z],We?N&&t.texSubImage2D(r.TEXTURE_2D,Z,0,0,me.width,me.height,_e,Pe,me.data):t.texImage2D(r.TEXTURE_2D,Z,ke,me.width,me.height,0,_e,Pe,me.data);T.generateMipmaps=!1}else We?(ct&&t.texStorage2D(r.TEXTURE_2D,K,ke,se.width,se.height),N&&t.texSubImage2D(r.TEXTURE_2D,0,0,0,se.width,se.height,_e,Pe,se.data)):t.texImage2D(r.TEXTURE_2D,0,ke,se.width,se.height,0,_e,Pe,se.data);else if(T.isCompressedTexture)if(T.isCompressedArrayTexture){We&&ct&&t.texStorage3D(r.TEXTURE_2D_ARRAY,K,ke,Ve[0].width,Ve[0].height,se.depth);for(let Z=0,J=Ve.length;Z<J;Z++)if(me=Ve[Z],T.format!==Qn)if(_e!==null)if(We){if(N)if(T.layerUpdates.size>0){const ae=sd(me.width,me.height,T.format,T.type);for(const Ae of T.layerUpdates){const Ye=me.data.subarray(Ae*ae/me.data.BYTES_PER_ELEMENT,(Ae+1)*ae/me.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(r.TEXTURE_2D_ARRAY,Z,0,0,Ae,me.width,me.height,1,_e,Ye,0,0)}T.clearLayerUpdates()}else t.compressedTexSubImage3D(r.TEXTURE_2D_ARRAY,Z,0,0,0,me.width,me.height,se.depth,_e,me.data,0,0)}else t.compressedTexImage3D(r.TEXTURE_2D_ARRAY,Z,ke,me.width,me.height,se.depth,0,me.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else We?N&&t.texSubImage3D(r.TEXTURE_2D_ARRAY,Z,0,0,0,me.width,me.height,se.depth,_e,Pe,me.data):t.texImage3D(r.TEXTURE_2D_ARRAY,Z,ke,me.width,me.height,se.depth,0,_e,Pe,me.data)}else{We&&ct&&t.texStorage2D(r.TEXTURE_2D,K,ke,Ve[0].width,Ve[0].height);for(let Z=0,J=Ve.length;Z<J;Z++)me=Ve[Z],T.format!==Qn?_e!==null?We?N&&t.compressedTexSubImage2D(r.TEXTURE_2D,Z,0,0,me.width,me.height,_e,me.data):t.compressedTexImage2D(r.TEXTURE_2D,Z,ke,me.width,me.height,0,me.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):We?N&&t.texSubImage2D(r.TEXTURE_2D,Z,0,0,me.width,me.height,_e,Pe,me.data):t.texImage2D(r.TEXTURE_2D,Z,ke,me.width,me.height,0,_e,Pe,me.data)}else if(T.isDataArrayTexture)if(We){if(ct&&t.texStorage3D(r.TEXTURE_2D_ARRAY,K,ke,se.width,se.height,se.depth),N)if(T.layerUpdates.size>0){const Z=sd(se.width,se.height,T.format,T.type);for(const J of T.layerUpdates){const ae=se.data.subarray(J*Z/se.data.BYTES_PER_ELEMENT,(J+1)*Z/se.data.BYTES_PER_ELEMENT);t.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,J,se.width,se.height,1,_e,Pe,ae)}T.clearLayerUpdates()}else t.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,0,se.width,se.height,se.depth,_e,Pe,se.data)}else t.texImage3D(r.TEXTURE_2D_ARRAY,0,ke,se.width,se.height,se.depth,0,_e,Pe,se.data);else if(T.isData3DTexture)We?(ct&&t.texStorage3D(r.TEXTURE_3D,K,ke,se.width,se.height,se.depth),N&&t.texSubImage3D(r.TEXTURE_3D,0,0,0,0,se.width,se.height,se.depth,_e,Pe,se.data)):t.texImage3D(r.TEXTURE_3D,0,ke,se.width,se.height,se.depth,0,_e,Pe,se.data);else if(T.isFramebufferTexture){if(ct)if(We)t.texStorage2D(r.TEXTURE_2D,K,ke,se.width,se.height);else{let Z=se.width,J=se.height;for(let ae=0;ae<K;ae++)t.texImage2D(r.TEXTURE_2D,ae,ke,Z,J,0,_e,Pe,null),Z>>=1,J>>=1}}else if(Ve.length>0){if(We&&ct){const Z=Be(Ve[0]);t.texStorage2D(r.TEXTURE_2D,K,ke,Z.width,Z.height)}for(let Z=0,J=Ve.length;Z<J;Z++)me=Ve[Z],We?N&&t.texSubImage2D(r.TEXTURE_2D,Z,0,0,_e,Pe,me):t.texImage2D(r.TEXTURE_2D,Z,ke,_e,Pe,me);T.generateMipmaps=!1}else if(We){if(ct){const Z=Be(se);t.texStorage2D(r.TEXTURE_2D,K,ke,Z.width,Z.height)}N&&t.texSubImage2D(r.TEXTURE_2D,0,0,0,_e,Pe,se)}else t.texImage2D(r.TEXTURE_2D,0,ke,_e,Pe,se);p(T)&&_(ee),be.__version=j.version,T.onUpdate&&T.onUpdate(T)}P.__version=T.version}function $(P,T,q){if(T.image.length!==6)return;const ee=Ie(P,T),ne=T.source;t.bindTexture(r.TEXTURE_CUBE_MAP,P.__webglTexture,r.TEXTURE0+q);const j=n.get(ne);if(ne.version!==j.__version||ee===!0){t.activeTexture(r.TEXTURE0+q);const be=pt.getPrimaries(pt.workingColorSpace),re=T.colorSpace===Ii?null:pt.getPrimaries(T.colorSpace),de=T.colorSpace===Ii||be===re?r.NONE:r.BROWSER_DEFAULT_WEBGL;r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,T.flipY),r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,T.premultiplyAlpha),r.pixelStorei(r.UNPACK_ALIGNMENT,T.unpackAlignment),r.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,de);const Ne=T.isCompressedTexture||T.image[0].isCompressedTexture,se=T.image[0]&&T.image[0].isDataTexture,_e=[];for(let J=0;J<6;J++)!Ne&&!se?_e[J]=m(T.image[J],!0,i.maxCubemapSize):_e[J]=se?T.image[J].image:T.image[J],_e[J]=Re(T,_e[J]);const Pe=_e[0],ke=s.convert(T.format,T.colorSpace),me=s.convert(T.type),Ve=y(T.internalFormat,ke,me,T.colorSpace),We=T.isVideoTexture!==!0,ct=j.__version===void 0||ee===!0,N=ne.dataReady;let K=x(T,Pe);oe(r.TEXTURE_CUBE_MAP,T);let Z;if(Ne){We&&ct&&t.texStorage2D(r.TEXTURE_CUBE_MAP,K,Ve,Pe.width,Pe.height);for(let J=0;J<6;J++){Z=_e[J].mipmaps;for(let ae=0;ae<Z.length;ae++){const Ae=Z[ae];T.format!==Qn?ke!==null?We?N&&t.compressedTexSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,ae,0,0,Ae.width,Ae.height,ke,Ae.data):t.compressedTexImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,ae,Ve,Ae.width,Ae.height,0,Ae.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):We?N&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,ae,0,0,Ae.width,Ae.height,ke,me,Ae.data):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,ae,Ve,Ae.width,Ae.height,0,ke,me,Ae.data)}}}else{if(Z=T.mipmaps,We&&ct){Z.length>0&&K++;const J=Be(_e[0]);t.texStorage2D(r.TEXTURE_CUBE_MAP,K,Ve,J.width,J.height)}for(let J=0;J<6;J++)if(se){We?N&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,0,0,_e[J].width,_e[J].height,ke,me,_e[J].data):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,Ve,_e[J].width,_e[J].height,0,ke,me,_e[J].data);for(let ae=0;ae<Z.length;ae++){const Ye=Z[ae].image[J].image;We?N&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,ae+1,0,0,Ye.width,Ye.height,ke,me,Ye.data):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,ae+1,Ve,Ye.width,Ye.height,0,ke,me,Ye.data)}}else{We?N&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,0,0,ke,me,_e[J]):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,Ve,ke,me,_e[J]);for(let ae=0;ae<Z.length;ae++){const Ae=Z[ae];We?N&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,ae+1,0,0,ke,me,Ae.image[J]):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,ae+1,Ve,ke,me,Ae.image[J])}}}p(T)&&_(r.TEXTURE_CUBE_MAP),j.__version=ne.version,T.onUpdate&&T.onUpdate(T)}P.__version=T.version}function Q(P,T,q,ee,ne,j){const be=s.convert(q.format,q.colorSpace),re=s.convert(q.type),de=y(q.internalFormat,be,re,q.colorSpace);if(!n.get(T).__hasExternalTextures){const se=Math.max(1,T.width>>j),_e=Math.max(1,T.height>>j);ne===r.TEXTURE_3D||ne===r.TEXTURE_2D_ARRAY?t.texImage3D(ne,j,de,se,_e,T.depth,0,be,re,null):t.texImage2D(ne,j,de,se,_e,0,be,re,null)}t.bindFramebuffer(r.FRAMEBUFFER,P),ge(T)?a.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,ee,ne,n.get(q).__webglTexture,0,Xe(T)):(ne===r.TEXTURE_2D||ne>=r.TEXTURE_CUBE_MAP_POSITIVE_X&&ne<=r.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&r.framebufferTexture2D(r.FRAMEBUFFER,ee,ne,n.get(q).__webglTexture,j),t.bindFramebuffer(r.FRAMEBUFFER,null)}function ue(P,T,q){if(r.bindRenderbuffer(r.RENDERBUFFER,P),T.depthBuffer){const ee=T.depthTexture,ne=ee&&ee.isDepthTexture?ee.type:null,j=v(T.stencilBuffer,ne),be=T.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,re=Xe(T);ge(T)?a.renderbufferStorageMultisampleEXT(r.RENDERBUFFER,re,j,T.width,T.height):q?r.renderbufferStorageMultisample(r.RENDERBUFFER,re,j,T.width,T.height):r.renderbufferStorage(r.RENDERBUFFER,j,T.width,T.height),r.framebufferRenderbuffer(r.FRAMEBUFFER,be,r.RENDERBUFFER,P)}else{const ee=T.textures;for(let ne=0;ne<ee.length;ne++){const j=ee[ne],be=s.convert(j.format,j.colorSpace),re=s.convert(j.type),de=y(j.internalFormat,be,re,j.colorSpace),Ne=Xe(T);q&&ge(T)===!1?r.renderbufferStorageMultisample(r.RENDERBUFFER,Ne,de,T.width,T.height):ge(T)?a.renderbufferStorageMultisampleEXT(r.RENDERBUFFER,Ne,de,T.width,T.height):r.renderbufferStorage(r.RENDERBUFFER,de,T.width,T.height)}}r.bindRenderbuffer(r.RENDERBUFFER,null)}function le(P,T){if(T&&T.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(r.FRAMEBUFFER,P),!(T.depthTexture&&T.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!n.get(T.depthTexture).__webglTexture||T.depthTexture.image.width!==T.width||T.depthTexture.image.height!==T.height)&&(T.depthTexture.image.width=T.width,T.depthTexture.image.height=T.height,T.depthTexture.needsUpdate=!0),X(T.depthTexture,0);const ee=n.get(T.depthTexture).__webglTexture,ne=Xe(T);if(T.depthTexture.format===Ls)ge(T)?a.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,r.DEPTH_ATTACHMENT,r.TEXTURE_2D,ee,0,ne):r.framebufferTexture2D(r.FRAMEBUFFER,r.DEPTH_ATTACHMENT,r.TEXTURE_2D,ee,0);else if(T.depthTexture.format===Ws)ge(T)?a.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,r.DEPTH_STENCIL_ATTACHMENT,r.TEXTURE_2D,ee,0,ne):r.framebufferTexture2D(r.FRAMEBUFFER,r.DEPTH_STENCIL_ATTACHMENT,r.TEXTURE_2D,ee,0);else throw new Error("Unknown depthTexture format")}function Ee(P){const T=n.get(P),q=P.isWebGLCubeRenderTarget===!0;if(P.depthTexture&&!T.__autoAllocateDepthBuffer){if(q)throw new Error("target.depthTexture not supported in Cube render targets");le(T.__webglFramebuffer,P)}else if(q){T.__webglDepthbuffer=[];for(let ee=0;ee<6;ee++)t.bindFramebuffer(r.FRAMEBUFFER,T.__webglFramebuffer[ee]),T.__webglDepthbuffer[ee]=r.createRenderbuffer(),ue(T.__webglDepthbuffer[ee],P,!1)}else t.bindFramebuffer(r.FRAMEBUFFER,T.__webglFramebuffer),T.__webglDepthbuffer=r.createRenderbuffer(),ue(T.__webglDepthbuffer,P,!1);t.bindFramebuffer(r.FRAMEBUFFER,null)}function we(P,T,q){const ee=n.get(P);T!==void 0&&Q(ee.__webglFramebuffer,P,P.texture,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,0),q!==void 0&&Ee(P)}function Te(P){const T=P.texture,q=n.get(P),ee=n.get(T);P.addEventListener("dispose",b);const ne=P.textures,j=P.isWebGLCubeRenderTarget===!0,be=ne.length>1;if(be||(ee.__webglTexture===void 0&&(ee.__webglTexture=r.createTexture()),ee.__version=T.version,o.memory.textures++),j){q.__webglFramebuffer=[];for(let re=0;re<6;re++)if(T.mipmaps&&T.mipmaps.length>0){q.__webglFramebuffer[re]=[];for(let de=0;de<T.mipmaps.length;de++)q.__webglFramebuffer[re][de]=r.createFramebuffer()}else q.__webglFramebuffer[re]=r.createFramebuffer()}else{if(T.mipmaps&&T.mipmaps.length>0){q.__webglFramebuffer=[];for(let re=0;re<T.mipmaps.length;re++)q.__webglFramebuffer[re]=r.createFramebuffer()}else q.__webglFramebuffer=r.createFramebuffer();if(be)for(let re=0,de=ne.length;re<de;re++){const Ne=n.get(ne[re]);Ne.__webglTexture===void 0&&(Ne.__webglTexture=r.createTexture(),o.memory.textures++)}if(P.samples>0&&ge(P)===!1){q.__webglMultisampledFramebuffer=r.createFramebuffer(),q.__webglColorRenderbuffer=[],t.bindFramebuffer(r.FRAMEBUFFER,q.__webglMultisampledFramebuffer);for(let re=0;re<ne.length;re++){const de=ne[re];q.__webglColorRenderbuffer[re]=r.createRenderbuffer(),r.bindRenderbuffer(r.RENDERBUFFER,q.__webglColorRenderbuffer[re]);const Ne=s.convert(de.format,de.colorSpace),se=s.convert(de.type),_e=y(de.internalFormat,Ne,se,de.colorSpace,P.isXRRenderTarget===!0),Pe=Xe(P);r.renderbufferStorageMultisample(r.RENDERBUFFER,Pe,_e,P.width,P.height),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+re,r.RENDERBUFFER,q.__webglColorRenderbuffer[re])}r.bindRenderbuffer(r.RENDERBUFFER,null),P.depthBuffer&&(q.__webglDepthRenderbuffer=r.createRenderbuffer(),ue(q.__webglDepthRenderbuffer,P,!0)),t.bindFramebuffer(r.FRAMEBUFFER,null)}}if(j){t.bindTexture(r.TEXTURE_CUBE_MAP,ee.__webglTexture),oe(r.TEXTURE_CUBE_MAP,T);for(let re=0;re<6;re++)if(T.mipmaps&&T.mipmaps.length>0)for(let de=0;de<T.mipmaps.length;de++)Q(q.__webglFramebuffer[re][de],P,T,r.COLOR_ATTACHMENT0,r.TEXTURE_CUBE_MAP_POSITIVE_X+re,de);else Q(q.__webglFramebuffer[re],P,T,r.COLOR_ATTACHMENT0,r.TEXTURE_CUBE_MAP_POSITIVE_X+re,0);p(T)&&_(r.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(be){for(let re=0,de=ne.length;re<de;re++){const Ne=ne[re],se=n.get(Ne);t.bindTexture(r.TEXTURE_2D,se.__webglTexture),oe(r.TEXTURE_2D,Ne),Q(q.__webglFramebuffer,P,Ne,r.COLOR_ATTACHMENT0+re,r.TEXTURE_2D,0),p(Ne)&&_(r.TEXTURE_2D)}t.unbindTexture()}else{let re=r.TEXTURE_2D;if((P.isWebGL3DRenderTarget||P.isWebGLArrayRenderTarget)&&(re=P.isWebGL3DRenderTarget?r.TEXTURE_3D:r.TEXTURE_2D_ARRAY),t.bindTexture(re,ee.__webglTexture),oe(re,T),T.mipmaps&&T.mipmaps.length>0)for(let de=0;de<T.mipmaps.length;de++)Q(q.__webglFramebuffer[de],P,T,r.COLOR_ATTACHMENT0,re,de);else Q(q.__webglFramebuffer,P,T,r.COLOR_ATTACHMENT0,re,0);p(T)&&_(re),t.unbindTexture()}P.depthBuffer&&Ee(P)}function Ke(P){const T=P.textures;for(let q=0,ee=T.length;q<ee;q++){const ne=T[q];if(p(ne)){const j=P.isWebGLCubeRenderTarget?r.TEXTURE_CUBE_MAP:r.TEXTURE_2D,be=n.get(ne).__webglTexture;t.bindTexture(j,be),_(j),t.unbindTexture()}}}const D=[],Ue=[];function Fe(P){if(P.samples>0){if(ge(P)===!1){const T=P.textures,q=P.width,ee=P.height;let ne=r.COLOR_BUFFER_BIT;const j=P.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,be=n.get(P),re=T.length>1;if(re)for(let de=0;de<T.length;de++)t.bindFramebuffer(r.FRAMEBUFFER,be.__webglMultisampledFramebuffer),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+de,r.RENDERBUFFER,null),t.bindFramebuffer(r.FRAMEBUFFER,be.__webglFramebuffer),r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0+de,r.TEXTURE_2D,null,0);t.bindFramebuffer(r.READ_FRAMEBUFFER,be.__webglMultisampledFramebuffer),t.bindFramebuffer(r.DRAW_FRAMEBUFFER,be.__webglFramebuffer);for(let de=0;de<T.length;de++){if(P.resolveDepthBuffer&&(P.depthBuffer&&(ne|=r.DEPTH_BUFFER_BIT),P.stencilBuffer&&P.resolveStencilBuffer&&(ne|=r.STENCIL_BUFFER_BIT)),re){r.framebufferRenderbuffer(r.READ_FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.RENDERBUFFER,be.__webglColorRenderbuffer[de]);const Ne=n.get(T[de]).__webglTexture;r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,Ne,0)}r.blitFramebuffer(0,0,q,ee,0,0,q,ee,ne,r.NEAREST),l===!0&&(D.length=0,Ue.length=0,D.push(r.COLOR_ATTACHMENT0+de),P.depthBuffer&&P.resolveDepthBuffer===!1&&(D.push(j),Ue.push(j),r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER,Ue)),r.invalidateFramebuffer(r.READ_FRAMEBUFFER,D))}if(t.bindFramebuffer(r.READ_FRAMEBUFFER,null),t.bindFramebuffer(r.DRAW_FRAMEBUFFER,null),re)for(let de=0;de<T.length;de++){t.bindFramebuffer(r.FRAMEBUFFER,be.__webglMultisampledFramebuffer),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+de,r.RENDERBUFFER,be.__webglColorRenderbuffer[de]);const Ne=n.get(T[de]).__webglTexture;t.bindFramebuffer(r.FRAMEBUFFER,be.__webglFramebuffer),r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0+de,r.TEXTURE_2D,Ne,0)}t.bindFramebuffer(r.DRAW_FRAMEBUFFER,be.__webglMultisampledFramebuffer)}else if(P.depthBuffer&&P.resolveDepthBuffer===!1&&l){const T=P.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT;r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER,[T])}}}function Xe(P){return Math.min(i.maxSamples,P.samples)}function ge(P){const T=n.get(P);return P.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&T.__useRenderToTexture!==!1}function Y(P){const T=o.render.frame;u.get(P)!==T&&(u.set(P,T),P.update())}function Re(P,T){const q=P.colorSpace,ee=P.format,ne=P.type;return P.isCompressedTexture===!0||P.isVideoTexture===!0||q!==gr&&q!==Ii&&(pt.getTransfer(q)===bt?(ee!==Qn||ne!==Vi)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",q)),T}function Be(P){return typeof HTMLImageElement<"u"&&P instanceof HTMLImageElement?(c.width=P.naturalWidth||P.width,c.height=P.naturalHeight||P.height):typeof VideoFrame<"u"&&P instanceof VideoFrame?(c.width=P.displayWidth,c.height=P.displayHeight):(c.width=P.width,c.height=P.height),c}this.allocateTextureUnit=I,this.resetTextureUnits=C,this.setTexture2D=X,this.setTexture2DArray=B,this.setTexture3D=V,this.setTextureCube=z,this.rebindTextures=we,this.setupRenderTarget=Te,this.updateRenderTargetMipmap=Ke,this.updateMultisampleRenderTarget=Fe,this.setupDepthRenderbuffer=Ee,this.setupFrameBufferTexture=Q,this.useMultisampledRTT=ge}function Zy(r,e){function t(n,i=Ii){let s;const o=pt.getTransfer(i);if(n===Vi)return r.UNSIGNED_BYTE;if(n===pf)return r.UNSIGNED_SHORT_4_4_4_4;if(n===mf)return r.UNSIGNED_SHORT_5_5_5_1;if(n===Mp)return r.UNSIGNED_INT_5_9_9_9_REV;if(n===xp)return r.BYTE;if(n===vp)return r.SHORT;if(n===Go)return r.UNSIGNED_SHORT;if(n===df)return r.INT;if(n===Xr)return r.UNSIGNED_INT;if(n===Oi)return r.FLOAT;if(n===na)return r.HALF_FLOAT;if(n===yp)return r.ALPHA;if(n===Sp)return r.RGB;if(n===Qn)return r.RGBA;if(n===Ep)return r.LUMINANCE;if(n===Tp)return r.LUMINANCE_ALPHA;if(n===Ls)return r.DEPTH_COMPONENT;if(n===Ws)return r.DEPTH_STENCIL;if(n===bp)return r.RED;if(n===_f)return r.RED_INTEGER;if(n===Ap)return r.RG;if(n===gf)return r.RG_INTEGER;if(n===xf)return r.RGBA_INTEGER;if(n===Ja||n===Qa||n===el||n===tl)if(o===bt)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(n===Ja)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===Qa)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===el)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===tl)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(n===Ja)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===Qa)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===el)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===tl)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===ru||n===su||n===ou||n===au)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(n===ru)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===su)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===ou)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===au)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===lu||n===cu||n===uu)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(n===lu||n===cu)return o===bt?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(n===uu)return o===bt?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===fu||n===hu||n===du||n===pu||n===mu||n===_u||n===gu||n===xu||n===vu||n===Mu||n===yu||n===Su||n===Eu||n===Tu)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(n===fu)return o===bt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===hu)return o===bt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===du)return o===bt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===pu)return o===bt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===mu)return o===bt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===_u)return o===bt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===gu)return o===bt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===xu)return o===bt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===vu)return o===bt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Mu)return o===bt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===yu)return o===bt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Su)return o===bt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Eu)return o===bt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Tu)return o===bt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===nl||n===bu||n===Au)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(n===nl)return o===bt?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===bu)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Au)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===wp||n===wu||n===Ru||n===Cu)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(n===nl)return s.COMPRESSED_RED_RGTC1_EXT;if(n===wu)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Ru)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Cu)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Gs?r.UNSIGNED_INT_24_8:r[n]!==void 0?r[n]:null}return{convert:t}}class Jy extends Fn{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class Ca extends Xt{constructor(){super(),this.isGroup=!0,this.type="Group"}}const Qy={type:"move"};class wc{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new Ca,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new Ca,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new H,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new H),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new Ca,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new H,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new H),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const t=this._hand;if(t)for(const n of e.hand.values())this._getHandJoint(t,n)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,t,n){let i=null,s=null,o=null;const a=this._targetRay,l=this._grip,c=this._hand;if(e&&t.session.visibilityState!=="visible-blurred"){if(c&&e.hand){o=!0;for(const m of e.hand.values()){const p=t.getJointPose(m,n),_=this._getHandJoint(c,m);p!==null&&(_.matrix.fromArray(p.transform.matrix),_.matrix.decompose(_.position,_.rotation,_.scale),_.matrixWorldNeedsUpdate=!0,_.jointRadius=p.radius),_.visible=p!==null}const u=c.joints["index-finger-tip"],f=c.joints["thumb-tip"],d=u.position.distanceTo(f.position),h=.02,g=.005;c.inputState.pinching&&d>h+g?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!c.inputState.pinching&&d<=h-g&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else l!==null&&e.gripSpace&&(s=t.getPose(e.gripSpace,n),s!==null&&(l.matrix.fromArray(s.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,s.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(s.linearVelocity)):l.hasLinearVelocity=!1,s.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(s.angularVelocity)):l.hasAngularVelocity=!1));a!==null&&(i=t.getPose(e.targetRaySpace,n),i===null&&s!==null&&(i=s),i!==null&&(a.matrix.fromArray(i.transform.matrix),a.matrix.decompose(a.position,a.rotation,a.scale),a.matrixWorldNeedsUpdate=!0,i.linearVelocity?(a.hasLinearVelocity=!0,a.linearVelocity.copy(i.linearVelocity)):a.hasLinearVelocity=!1,i.angularVelocity?(a.hasAngularVelocity=!0,a.angularVelocity.copy(i.angularVelocity)):a.hasAngularVelocity=!1,this.dispatchEvent(Qy)))}return a!==null&&(a.visible=i!==null),l!==null&&(l.visible=s!==null),c!==null&&(c.visible=o!==null),this}_getHandJoint(e,t){if(e.joints[t.jointName]===void 0){const n=new Ca;n.matrixAutoUpdate=!1,n.visible=!1,e.joints[t.jointName]=n,e.add(n)}return e.joints[t.jointName]}}const eS=`
void main() {
 ...
 * Club GSAP members, the agreement issued with that membership.
 * @author: Jack Doyle, jack@greensock.com
*/var en,al,zn,or,ar,Os,Ym,Pr,Io,qm,Bi,ui,$m,Km=function(){return en||typeof window<"u"&&(en=window.gsap)&&en.registerPlugin&&en},jm=1,Rs=[],Qe=[],Ei=[],Uo=Date.now,ju=function(e,t){return t},mT=function(){var e=Io.core,t=e.bridge||{},n=e._scrollers,i=e._proxies;n.push.apply(n,Qe),i.push.apply(i,Ei),Qe=n,Ei=i,ju=function(o,a){return t[o](a)}},hr=function(e,t){return~Ei.indexOf(e)&&Ei[Ei.indexOf(e)+1][t]},No=function(e){return!!~qm.indexOf(e)},dn=function(e,t,n,i,s){return e.addEventListener(t,n,{passive:i!==!1,capture:!!s})},fn=function(e,t,n,i){return e.removeEventListener(t,n,!!i)},Fa="scrollLeft",Ba="scrollTop",Zu=function(){return Bi&&Bi.isPressed||Qe.cache++},Dl=function(e,t){var n=function i(s){if(s||s===0){jm&&(zn.history.scrollRestoration="manual");var o=Bi&&Bi.isPressed;s=i.v=Math.round(s)||(Bi&&Bi.iOS?1:0),e(s),i.cacheID=Qe.cache,o&&ju("ss",s)}else(t||Qe.cache!==i.cacheID||ju("ref"))&&(i.cacheID=Qe.cache,i.v=e());return i.v+i.offset};return n.offset=0,e&&n},Mn={s:Fa,p:"left",p2:"Left",os:"right",os2:"Right",d:"width",d2:"Width",a:"x",sc:Dl(function(r){return arguments.length?zn.scrollTo(r,Ht.sc()):zn.pageXOffset||or[Fa]||ar[Fa]||Os[Fa]||0})},Ht={s:Ba,p:"top",p2:"Top",os:"bottom",os2:"Bottom",d:"height",d2:"Height",a:"y",op:Mn,sc:Dl(function(r){return arguments.length?zn.scrollTo(Mn.sc(),r):zn.pageYOffset||or[Ba]||ar[Ba]||Os[Ba]||0})},Sn=function(e,t){return(t&&t._ctx&&t._ctx.selector||en.utils.toArray)(e)[0]||(typeof e=="string"&&en.config().nullTargetWarn!==!1?console.warn("Element not found:",e):null)},_r=function(e,t){var n=t.s,i=t.sc;No(e)&&(e=or.scrollingElement||ar);var s=Qe.indexOf(e),o=i===Ht.sc?1:2;!~s&&(s=Qe.push(e)-1),Qe[s+o]||dn(e,"scroll",Zu);var a=Qe[s+o],l=a||(Qe[s+o]=Dl(hr(e,n),!0)||(No(e)?i:Dl(function(c){return arguments.length?e[n]=c:e[n]})));return l.target=e,a||(l.smooth=en.getProperty(e,"scrollBehavior")==="smooth"),l},Ju=function(e,t,n){var i=e,s=e,o=Uo(),a=o,l=t||50,c=Math.max(500,l*3),u=function(g,m){var p=Uo();m||p-o>l?(s=i,i=g,a=o,o=p):n?i+=g:i=s+(g-s)/(p-a)*(o-a)},f=function(){s=i=n?0:i,a=o=0},d=function(g){var m=a,p=s,_=Uo();return(g||g===0)&&g!==i&&u(g),o===a||_-a>c?0:(i+(n?p:-p))/((n?_:o)-m)*1e3};return{update:u,reset:f,getVelocity:d}},fo=function(e,t){return t&&!e._gsapAllow&&e.preventDefault(),e.changedTouches?e.changedTouches[0]:e},Vd=function(e){var t=Math.max.apply(Math,e),n=Math.min.apply(Math,e);return Math.abs(t)>=Math.abs(n)?t:n},Zm=function(){Io=en.core.globals().ScrollTrigger,Io&&Io.core&&mT()},Jm=function(e){return en=e||Km(),!al&&en&&typeof document<"u"&&document.body&&(zn=window,or=document,ar=or.documentElement,Os=or.body,qm=[zn,or,ar,Os],en.utils.clamp,$m=en.core.context||function(){},Pr="onpointerenter"in Os?"pointer":"mouse",Ym=Ut.isTouch=zn.matchMedia&&zn.matchMedia("(hover: none), (pointer: coarse)").matches?1:"ontouchstart"in zn||navigator.maxTouchPoints>0||navigator.msMaxTouchPoints>0?2:0,ui=Ut.eventTypes=("ontouchstart"in ar?"touchstart,touchmove,touchcancel,touchend":"onpointerdown"in ar?"pointerdown,pointermove,pointercancel,pointerup":"mousedown,mousemove,mouseup,mouseup").split(","),setTimeout(function(){return jm=0},500),Zm(),al=1),al};Mn.op=Ht;Qe.cache=0;var Ut=function(){function r(t){this.init(t)}var e=r.prototype;return e.init=function(n){al||Jm(en)||console.warn("Please gsap.registerPlugin(Observer)"),Io||Zm();var i=n.tolerance,s=n.dragMinimum,o=n.type,a=n.target,l=n.lineHeight,c=n.debounce,u=n.preventDefault,f=n.onStop,d=n.onStopDelay,h=n.ignore,g=n.wheelSpeed,m=n.event,p=n.onDragStart,_=n.onDragEnd,y=n.onDrag,v=n.onPress,x=n.onRelease,w=n.onRight,b=n.onLeft,E=n.onUp,R=n.onDown,S=n.onChangeX,M=n.onChangeY,C=n.onChange,I=n.onToggleX,F=n.onToggleY,X=n.onHover,B=n.onHoverEnd,V=n.onMove,z=n.ignoreCheck,G=n.isNormalizer,ie=n.onGestureStart,L=n.onGestureEnd,oe=n.onWheel,Ie=n.onEnable,ze=n.onDisable,$=n.onClick,Q=n.scrollSpeed,ue=n.capture,le=n.allowClicks,Ee=n.lockAxis,we=n.onLockAxis;this.target=a=Sn(a)||ar,this.vars=n,h&&(h=en.utils.toArray(h)),i=i||1e-9,s=s||0,g=g||1,Q=Q||1,o=o||"wheel,touch,pointer",c=c!==!1,l||(l=parseFloat(zn.getComputedStyle(Os).lineHeight)||22);var Te,Ke,D,Ue,Fe,Xe,ge,Y=this,Re=0,Be=0,P=n.passive||!u,T=_r(a,Mn),q=_r(a,Ht),ee=T(),ne=q(),j=~o.indexOf("touch")&&!~o.indexOf("pointer")&&ui[0]==="pointerdown",be=No(a),re=a.ownerDocument||or,de=[0,0,0],Ne=[0,0,0],se=0,_e=function(){return se=Uo()},Pe=function(Se,ot){return(Y.event=Se)&&h&&~h.indexOf(Se.target)||ot&&j&&Se.pointerType!=="touch"||z&&z(Se,ot)},ke=function(){Y._vx.reset(),Y._vy.reset(),Ke.pause(),f&&f(Y)},me=function(){var Se=Y.deltaX=Vd(de),ot=Y.deltaY=Vd(Ne),ce=Math.abs(Se)>=i,He=Math.abs(ot)>=i;C&&(ce||He)&&C(Y,Se,ot,de,Ne),ce&&(w&&Y.deltaX>0&&w(Y),b&&Y.deltaX<0&&b(Y),S&&S(Y),I&&Y.deltaX<0!=Re<0&&I(Y),Re=Y.deltaX,de[0]=de[1]=de[2]=0),He&&(R&&Y.deltaY>0&&R(Y),E&&Y.deltaY<0&&E(Y),M&&M(Y),F&&Y.deltaY<0!=Be<0&&F(Y),Be=Y.deltaY,Ne[0]=Ne[1]=Ne[2]=0),(Ue||D)&&(V&&V(Y),D&&(y(Y),D=!1),Ue=!1),Xe&&!(Xe=!1)&&we&&we(Y),Fe&&(oe(Y),Fe=!1),Te=0},Ve=function(Se,ot,ce){de[ce]+=Se,Ne[ce]+=ot,Y._vx.update(Se),Y._vy.update(ot),c?Te||(Te=requestAnimationFrame(me)):me()},We=function(Se,ot){Ee&&!ge&&(Y.axis=ge=Math.abs(Se)>Math.abs(ot)?"x":"y",Xe=!0),ge!=="y"&&(de[2]+=Se,Y._vx.update(Se,!0)),ge!=="x"&&(Ne[2]+=ot,Y._vy.update(ot,!0)),c?Te||(Te=requestAnimationFrame(me)):me()},ct=function(Se){if(!Pe(Se,1)){Se=fo(Se,u);var ot=Se.clientX,ce=Se.clientY,He=ot-Y.x,Le=ce-Y.y,Ge=Y.isDragging;Y.x=ot,Y.y=ce,(Ge||Math.abs(Y.startX-ot)>=s||Math.abs(Y.startY-ce)>=s)&&(y&&(D=!0),Ge||(Y.isDragging=!0),We(He,Le),Ge||p&&p(Y))}},N=Y.onPress=function(Oe){Pe(Oe,1)||Oe&&Oe.button||(Y.axis=ge=null,Ke.pause(),Y.isPressed=!0,Oe=fo(Oe),Re=Be=0,Y.startX=Y.x=Oe.clientX,Y.startY=Y.y=Oe.clientY,Y._vx.reset(),Y._vy.reset(),dn(G?a:re,ui[1],ct,P,!0),Y.deltaX=Y.deltaY=0,v&&v(Y))},K=Y.onRelease=function(Oe){if(!Pe(Oe,1)){fn(G?a:re,ui[1],ct,!0);var Se=!isNaN(Y.y-Y.startY),ot=Y.isDragging,ce=ot&&(Math.abs(Y.x-Y.startX)>3||Math.abs(Y.y-Y.startY)>3),He=fo(Oe);!ce&&Se&&(Y._vx.reset(),Y._vy.reset(),u&&le&&en.delayedCall(.08,function(){if(Uo()-se>300&&!Oe.defaultPrevented){if(Oe.target.click)Oe.target.click();else if(re.createEvent){var Le=re.createEvent("MouseEvents");Le.initMouseEvent("click",!0,!0,zn,1,He.screenX,He.screenY,He.clientX,He.clientY,!1,!1,!1,!1,0,null),Oe.target.dispatchEvent(Le)}}})),Y.isDragging=Y.isGesturing=Y.isPressed=!1,f&&ot&&!G&&Ke.restart(!0),_&&ot&&_(Y),x&&x(Y,ce)}},Z=function(Se){return Se.touches&&Se.touches.length>1&&(Y.isGesturing=!0)&&ie(Se,Y.isDragging)},J=function(){return(Y.isGesturing=!1)||L(Y)},ae=function(Se){if(!Pe(Se)){var ot=T(),ce=q();Ve((ot-ee)*Q,(ce-ne)*Q,1),ee=ot,ne=ce,f&&Ke.restart(!0)}},Ae=function(Se){if(!Pe(Se)){Se=fo(Se,u),oe&&(Fe=!0);var ot=(Se.deltaMode===1?l:Se.deltaMode===2?zn.innerHeight:1)*g;Ve(Se.deltaX*ot,Se.deltaY*ot,0),f&&!G&&Ke.restart(!0)}},Ye=function(Se){if(!Pe(Se)){var ot=Se.clientX,ce=Se.clientY,He=ot-Y.x,Le=ce-Y.y;Y.x=ot,Y.y=ce,Ue=!0,f&&Ke.restart(!0),(He||Le)&&We(He,Le)}},gt=function(Se){Y.event=Se,X(Y)},xt=function(Se){Y.event=Se,B(Y)},et=function(Se){return Pe(Se)||fo(Se,u)&&$(Y)};Ke=Y._dc=en.delayedCall(d||.25,ke).pause(),Y.deltaX=Y.deltaY=0,Y._vx=Ju(0,50,!0),Y._vy=Ju(0,50,!0),Y.scrollX=T,Y.scrollY=q,Y.isDragging=Y.isGesturing=Y.isPressed=!1,$m(this),Y.enable=function(Oe){return Y.isEnabled||(dn(be?re:a,"scroll",Zu),o.indexOf("scroll")>=0&&dn(be?re:a,"scroll",ae,P,ue),o.indexOf("wheel")>=0&&dn(a,"wheel",Ae,P,ue),(o.indexOf("touch")>=0&&Ym||o.indexOf("pointer")>=0)&&(dn(a,ui[0],N,P,ue),dn(re,ui[2],K),dn(re,ui[3],K),le&&dn(a,"click",_e,!0,!0),$&&dn(a,"click",et),ie&&dn(re,"gesturestart",Z),L&&dn(re,"gestureend",J),X&&dn(a,Pr+"enter",gt),B&&dn(a,Pr+"leave",xt),V&&dn(a,Pr+"move",Ye)),Y.isEnabled=!0,Oe&&Oe.type&&N(Oe),Ie&&Ie(Y)),Y},Y.disable=function(){Y.isEnabled&&(Rs.filter(function(Oe){return Oe!==Y&&No(Oe.target)}).length||fn(be?re:a,"scroll",Zu),Y.isPressed&&(Y._vx.reset(),Y._vy.reset(),fn(G?a:re,ui[1],ct,!0)),fn(be?re:a,"scroll",ae,ue),fn(a,"wheel",Ae,ue),fn(a,ui[0],N,ue),fn(re,ui[2],K),fn(re,ui[3],K),fn(a,"click",_e,!0),fn(a,"click",et),fn(re,"gesturestart",Z),fn(re,"gestureend",J),fn(a,Pr+"enter",gt),fn(a,Pr+"leave",xt),fn(a,Pr+"move",Ye),Y.isEnabled=Y.isPressed=Y.isDragging=!1,ze&&ze(Y))},Y.kill=Y.revert=function(){Y.disable();var Oe=Rs.indexOf(Y);Oe>=0&&Rs.splice(Oe,1),Bi===Y&&(Bi=0)},Rs.push(Y),G&&No(a)&&(Bi=Y),Y.enable(m)},pT(r,[{key:"velocityX",get:function(){return this._vx.getVelocity()}},{key:"velocityY",get:function(){return this._vy.getVelocity()}}]),r}();Ut.version="3.12.5";Ut.create=function(r){return new Ut(r)};Ut.register=Jm;Ut.getAll=function(){return Rs.slice()};Ut.getById=function(r){return Rs.filter(function(e){return e.vars.id===r})[0]};Km()&&en.registerPlugin(Ut);/*!
